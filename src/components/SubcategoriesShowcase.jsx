  ...
  return (
    <section id="explora" className="relative overflow-hidden bg-[#0d0d14] py-16 md:py-24">
      ...
      <div className="relative max-w-screen-xl mx-auto px-4 md:px-8 lg:px-12 flex flex-col items-center">
        ...
        {activeCat && (
          <div key={activeCat.id} className="w-full max-w-[1150px] min-h-[320px] md:min-h-[380px]">
                  ...
                  return (
                    <BlurFade key={sub.id} inView delay={i * 0.1} duration={0.5}>
                      <button
                        ...
                        className="group relative overflow-hidden rounded-3xl w-full text-left border border-white/5 hover:border-amber-500/40 transition-all duration-500 hover:shadow-2xl hover:shadow-amber-500/20 h-[260px] sm:h-[300px] md:h-[360px]"
                      >
                        {img ? (
                          <OptimizedImage
                            src={img}
                            ...
                            className="absolute inset-0 w-full h-full object-cover object-center brightness-110 contrast-105 transition-transform duration-1000 group-hover:scale-105"
                          />
                        ) : (
                        ...
                        {/* Top Badge */}
                        <div className="absolute top-4 left-4 md:top-5 md:left-5 max-w-[70%]">
                          <div className="flex items-center gap-2 bg-black/60 backdrop-blur-md border border-white/10 px-3 py-1.5 rounded-full">
                            ...
                            <span className="truncate text-[10px] font-black text-white/90 uppercase tracking-widest">
                              {activeCat.name}
                            </span>
                          </div>
                        </div>
                        ...
                        {/* Flecha Hover */}
                        <div className="absolute top-4 right-4 md:top-5 md:right-5 flex items-center justify-center w-10 h-10 rounded-full bg-black/50 backdrop-blur-md border border-white/10 group-hover:bg-amber-500 group-hover:border-amber-500 transition-all duration-300 transform group-hover:rotate-45">
                          <span className="text-white text-xl font-bold">↗</span>
                        </div>

                        {/* Contenido Textual (Más grande para el formato 1150x600) */}
                        <div className="absolute bottom-0 left-0 right-0 p-5 md:p-7 w-full">
                          <h3 className="text-lg md:text-xl lg:text-2xl font-black uppercase text-white mb-2 group-hover:text-amber-400 transition-colors duration-300 leading-tight">
                            {sub.name}
                          </h3>
                          ...
                          <div className="flex flex-wrap items-center gap-2 md:gap-3">
                            <div className="flex items-center gap-2 bg-amber-500/20 backdrop-blur-sm border border-amber-500/30 px-3 py-1.5 rounded-full">
                              <Icon name="inventory_2" className="text-amber-500 text-sm" />
                              <span className="text-[9px] md:text-[10px] font-black text-amber-400 uppercase tracking-widest">
                                {sub.count} productos disponibles
                              </span>
                            </div>
                            <div className="inline-flex items-center gap-2 text-white px-2 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-widest group-hover:text-amber-500 transition-colors">
        ...
        <BlurFade inView delay={0.2} duration={0.4} className="w-full max-w-[1150px]">
          <div className="mt-12 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5 p-6 md:p-8 rounded-[2rem] bg-[#15151d] border border-white/10 shadow-2xl shadow-black/20">
            <div className="relative pl-4">
              <div className="absolute left-0 top-1 bottom-1 w-[3px] rounded-full bg-[#25D366]" />
              <p className="text-lg md:text-xl font-black text-white uppercase tracking-wide mb-2">
                ¿No encuentras lo que buscas?
              </p>
              <p className="text-sm md:text-base text-zinc-300 leading-relaxed">
                Escríbenos por WhatsApp y te asesoramos en tu pedido al por mayor.
              </p>
              <p className="mt-2 text-[11px] font-bold uppercase tracking-widest text-[#25D366]">
                Respuesta directa para cotizaciones B2B
              </p>
            </div>
            <div className="flex gap-3 shrink-0 w-full sm:w-auto">
              <a
                ...
                className="flex w-full sm:w-auto items-center justify-center gap-2 px-6 py-4 bg-[#25D366] hover:bg-[#20BA5A] text-white text-xs font-black uppercase tracking-widest rounded-xl transition-all active:scale-95 shadow-lg shadow-[#25D366]/25"
              >
